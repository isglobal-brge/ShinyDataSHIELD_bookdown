...
The server file is divided into the following blocks.
  ...
  + Stop function: This delcaration is left for future developers. When having troubble on a certain spot, add a stop button using `actionButton("stop", "stop")`, press it on the GUI to stop the execution and perform the required debugging.
